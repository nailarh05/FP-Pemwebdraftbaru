...
interface Word {
  ...
  clickOrder?: number; // Menyimpan urutan klik pemain
}
...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: "Despite the fact that she was tired , she finished her homework .",
  },
];
        ...
        <Card className="w-full max-w-md p-8 text-center shadow-2xl">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="text-2xl font-semibold text-gray-700">Skor: {score} / {totalQuestions}</div>
            ...
            <div className="flex gap-4 pt-4">
              <Button
                onClick={() => {
                  ...
                  setWords([...QUESTIONS[0].words].sort(() => Math.random() - 0.5));
                  setClickCounter(0);
                  setScore(0);
                  setGameEnded(false);
