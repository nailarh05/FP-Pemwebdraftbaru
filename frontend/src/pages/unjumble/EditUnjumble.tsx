                ...
                <div className="max-w-3xl w-full space-y-6">
                    ...
                    <div className="bg-white w-full h-full p-6 space-y-6 rounded-xl border">
                        ...
                        <div>
                            {thumbnailPreview && (
                                <div className="mb-2">
                                    <img src={thumbnailPreview} alt="Current Thumbnail" className="h-32 w-auto rounded object-cover" />
                                </div>
                            )}
                            <Dropzone
                            ...
                            <Dialog open={isGenerateOpen} onOpenChange={setIsGenerateOpen}>
                                ...
                                <DialogContent>
                                    ...
                                    <DialogFooter>
                                        ...
                                        <Button onClick={handleMagicGenerate} disabled={isGenerating || !generateTopic}>
                    ...
                    {sentences.map((s, sIndex) => (
                        <div key={sIndex} className="bg-white w-full h-full p-6 space-y-6 rounded-xl border">
                            ...
                            <TextareaField
                                ...
                                onChange={(e) => handleSentenceTextChange(sIndex, e.target.value)}
                            />
                        </div>
                    ))}
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div>
                                <Switch
                                    ...
                                    onCheckedChange={(val) => setSettings(prev => ({ ...prev, isRandomized: val }))}
                                />
                            </div>
                        </div>
                        <div className="flex justify-between items-center">
                            <FormField
                                ...
                                onChange={(e) => setSettings(prev => ({ ...prev, scorePerSentence: Number(e.target.value) }))}
                            />
                        </div>
                    </div>
